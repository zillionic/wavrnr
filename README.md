...
- 시드를 10등분해서, 하루 고점 대비 -3% 하락 시 1차 매수
- 직전 매수가 대비 추가 -1% 하락마다 다음 매수 (최대 10회 = 시드 100%)
- 익절: 직전 저점(가장 최근 매수가) 대비 +6% 오르면 전량 매도, 처음부터 재시작 — 매수할 때마다 목표가도 새 저점 기준으로 갱신됨
- 손절: 매수 횟수와 무관하게, 첫 매수가 대비 -4% 하락하면 전량 강제 매도
- 거래 수수료 0.1%/건 반영
