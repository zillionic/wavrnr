...
- 하루 고점 대비 -1.5% 하락 시 1차 매수 (시드 20%)
- 직전 매수가 대비 추가 -1% 하락마다 분할 매수 (시드 10%씩, 최대 3회까지)
- 익절: 그날 고점 대비 +1% 상승하면 전량 매도, 처음부터 재시작
- 손절: 3회 매수한 뒤 추가로 -1% 더 빠지면(=4번째 매수 신호가 뜨는 시점) 매수 대신 전량 강제 매도
- 손절 백업: 위 조건 전에 그날 고점 대비 -5% 하락하면 매수 횟수와 무관하게 즉시 전량 매도 (급락 대비 안전장치)
- 거래 수수료 0.1%/건 반영
